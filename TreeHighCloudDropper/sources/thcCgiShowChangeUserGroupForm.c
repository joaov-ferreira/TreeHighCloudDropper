 ...
 * $Log: thcCgiShowChangeUserGroupForm.c,v $
...
char *menssages[][2]=
{
	{"Select user to change to a group","Selecione o usuário para ter o grupo alterado"},
...
int main (int argc, char **argv)
{
	...
	printf("			<form action='thcChangeGroup.cgi' method='post'>                                                                \n");
...
/*$RCSfile: thcCgiShowChangeUserGroupForm.c,v $*/                                  
